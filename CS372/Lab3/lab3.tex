...
%
% TODO: Create new styles for 'Question' and 'Answer'
%       and abstract a template from this file for future
%       labs.
% TODO: Find good way to include network traces
% TODO: Remove large margins around side. Reduce to maybe 1in?
%%%%%%
\documentclass[12pt,letterpaper]{article}
% Preamble
% Answer/Question Style
%  Abstract method to take input, and place input into
%  'Question' area
% \newcommand{\question}{\textbf{Question}\\\tab}
% \newcommand{\question}[1]{\textbf{#1}\\\tab}
% \newcommand --- ALIAS answer -> question
\begin{document}
