...
\begin{enumerate}
    \item All project must be submitted electronically by 23:59:59 on the due
          date via TEACH – use “Check time on server” if unsure about your clock. TEACH
          time takes priority over your local computer.
    ...
    \item Naming convention: CS311 proj x engr username .tar.bz2. Fill in with appropriate values.
...
\begin{itemize}
    ...
    \item Write a program that spawns processes and provides mutual exclusion
          for variables or other resources
    \item shared by the processes.
